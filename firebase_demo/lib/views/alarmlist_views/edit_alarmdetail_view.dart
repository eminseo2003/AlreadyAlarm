...
class AddAlarmDetailViewState extends State<AddAlarmDetailView> {
  ...
  void initState() {
    ...
    _isDateEnabled = (_selectedDate == null) ? false : true;
    _isTimeEnabled = (_selectedTime == null) ? false : true;
    _isRepeatEnabled = (_selectedRepeat == RepeatFrequency.none) ? false : true;
    _isLocationEnabled = (_locationController.text == "") ? false : true;
    _isEndDateEnabled = (_selectedRepeatEndDate == null) ? false : true;
  }
  void _saveAndReturn() {
